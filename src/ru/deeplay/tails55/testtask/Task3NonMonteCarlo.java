...
// Значительно медленнее (ну как, у меня +- одинаково времени уходило на монте-карло на 4*250к игр по 1к бросков и
// симуляцию 1к бросков через ДП), но в плане точности ограничено только даблами (можно переписать на BigInteger,
